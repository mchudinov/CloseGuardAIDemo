...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        try
        {
            ...
            Serilog.Log.Logger.Information("CloseGuard web is running");
            ...
            //{
            //    return sp.GetService<AzureOpenAIClient>().GetEmbeddingClient(settings.AzureOpenAI.DeploymentNameEmbedding);
            //});
            ...
            {
                app.UseDeveloperExceptionPage(); // For detailed errors in development
            }
            else
            {
        ...
        {
            Serilog.Log.Fatal(ex, "CloseGuard worker process terminated unexpectedly.");
        }
        finally
        {
